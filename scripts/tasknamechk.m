...
if isnumeric(names)
    ...
    isValid = ismember(names, namestore.TaskOrigName) |...
        ismember(names, namestore.TaskName) | ...
        ismember(names, namestore.TaskCNName) | ...
    ...
    for iname = 1:length(names)
        name = names{iname};
        locs = ismember(namestore.TaskOrigName, name) |...
            ismember(namestore.TaskName, name) | ...
            ismember(namestore.TaskCNName, name) | ...
